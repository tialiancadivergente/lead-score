    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'target_survey_response_rate', type: 'numeric', isNullable: true },
          { name: 'target_consciousness_rate', type: 'numeric', isNullable: true },
          { name: 'target_knows_elton_rate', type: 'numeric', isNullable: true },
          { name: 'target_knows_alliance_rate', type: 'numeric', isNullable: true },
          // question keys
          { name: 'question_key_consciousness', type: 'text', isNullable: true },
          { name: 'positive_option_key_consciousness', type: 'text', isNullable: true },
          { name: 'question_key_knows_elton', type: 'text', isNullable: true },
          { name: 'positive_option_key_knows_elton', type: 'text', isNullable: true },
          { name: 'question_key_knows_alliance', type: 'text', isNullable: true },
          { name: 'positive_option_key_knows_alliance', type: 'text', isNullable: true },
          // timestamps
